...
Constructor.prototype.visitEmpty = function visitEmpty(ast) {
  return null;
};

Constructor.prototype.visitDebugger = function visitDebugger(ast) {
  return this.bind(this.pipeline.add('debugger'), ast);
};
